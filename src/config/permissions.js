export const pagePermissions = {
  ...
  malaysia: {
    ...
    leads: 'manage_handoff',
    cases: 'edit_patient',
    documents: 'upload_document',
    tasks: 'publish_summary',
    resources: 'assign_expert',
    record: 'edit_patient',
  },
  china: {
    dashboard: 'view_china_records',
    intake: 'view_china_records',
    records: 'view_china_records',
    handoff: 'view_access_audit',
    record: 'view_china_records',
  },
  expert: {
