...
export const pageSchemas = {
  ...
  malaysia: {
    leads: {
      ...
      rows: [
        {id:'LEAD-260621-01',cells:['陈伟强','TikTok','胃癌','+60 12-*** 1120','待首次联系','Nur']},
        {id:'LEAD-260621-02',cells:['Mohd Azlan','Facebook','肝癌','+60 17-*** 2198','已预约视频咨询','Aisyah']},
        {id:'LEAD-260620-09',cells:['黄丽珍','患者转介绍','卵巢癌','+60 16-*** 8802','已转患者','Farah']},
      ],
    },
    cases: {
    ...
    resources: {
      ...
      rows: [
        {id:'RES-001',cells:['Sunway Medical Centre','医院','Kuala Lumpur','肿瘤复查 / 急诊','合作中','Dr. Lee']},
        {id:'RES-008',cells:['BP Healthcare Bangsar','检验中心','Kuala Lumpur','血液 / 肿瘤标志物','可预约','Ms. Tan']},
        {id:'RES-015',cells:['ReGen Rehab Centre','康复机构','Petaling Jaya','术后康复 / 营养','合作中','Farah']},
      ],
    },
  },
  china: {
