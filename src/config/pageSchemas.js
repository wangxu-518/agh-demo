export const pageSchemas = {
  ...
  malaysia: {
    leads: {
      eyebrow: 'TREATMENT JOURNEY', title: '治疗行程与跨境交接', description: '由马来运营统一维护面诊、检查、住院、治疗、复诊和返程节点',
      type: 'journey', primary: ['完成赴华交接', 'completeHandoff'],
      metrics: [['待确认节点','4'],['距离入院','7天'],['患者已确认','是'],['医院已确认','待确认']],
    },
    cases: {
      eyebrow: 'PATIENT RECORDS', title: '患者档案', description: '管理患者主档、服务阶段、资料状态及国内诊疗资料入口',
      type: 'table', primary: ['完成主案例初筛', 'submitCase'],
      metrics: [['服务中患者','46'],['待补资料','7'],['专家评审中','12'],['本月赴华','9']],
      filters: ['全部患者','新咨询','专家评审','在华治疗','归国随访'],
      columns: ['患者','Case ID','诊断','当前阶段','服务负责人'],
      rowSource: 'patientCases',
    },
    documents: {
      eyebrow: 'DOCUMENT COLLECTION', title: '资料采集', description: '咨询表、授权书和医疗资料的采集、分类、完整性与版本管理',
      type: 'documents', primary: ['补齐并锁定资料', 'lockDocuments'],
      metrics: [['待补资料','7'],['待签合同','4'],['授权待确认','2'],['今日新增文件','18']],
    },
    tasks: {
      eyebrow: 'AI CASE STRUCTURING', title: 'AI 病案整理', description: '模拟资料分类、合并、字段提取和病程时间轴，并由运营人员人工确认',
      type: 'documents', primary: ['确认 AI 病案摘要', 'publishSummary'],
  ...
  china: {
    intake: {
      eyebrow: 'TREATMENT TIMELINE', title: '国内治疗时间轴', description: '按治疗阶段查看医院上传的检查、手术、康复和出院记录',
      type: 'timeline', readOnly: true,
      metrics: [['治疗节点','6'],['已归档','4'],['待上传','2'],['最新更新','今天']],
    },
    records: {
      eyebrow: 'CHINA MEDICAL RECORDS', title: '国内诊疗资料', description: '只读展示医院上传并留存在中国数据域的资料',
      type: 'documents', readOnly: true,
    ...
    handoff: {
      ...
      type: 'table', readOnly: true,
      metrics: [['今日访问','6'],['授权通过','6'],['被拒访问','1'],['异常访问','0']],
      columns: ['访问人','患者','资料范围','访问用途','访问时间','结果'],
      rows: [
        {id:'AUD-CN-001',cells:['Aisyah','王美玲','手术记录 / 康复方案','制定术后健康计划','今天 09:42','已授权']},
        {id:'AUD-CN-002',cells:['Farah','王美玲','康复方案','家访计划复核','昨天 16:18','已授权']},
      ],
    },
  },
  expert: {
  ...
  health: {
    ...
    'home-visits': {
      ...
      metrics: [['今日家访','5'],['执行中','2'],['待提交','1'],['高风险','0']],
    },
    alerts: {
