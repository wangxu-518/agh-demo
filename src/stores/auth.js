...
const PORTAL_KEY = 'agh-demo-portal-session-v3'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  const portalSession = ref(JSON.parse(sessionStorage.getItem(PORTAL_KEY) || 'null'))
  ...
  watch(portalSession, (value) => sessionStorage.setItem(PORTAL_KEY, JSON.stringify(value)), { deep: true })
